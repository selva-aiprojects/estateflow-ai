...
CREATE TABLE units (
    ...
    unit_type     varchar(40) NOT NULL CHECK (unit_type IN ('1BHK','2BHK','3BHK','4BHK','5BHK','penthouse','office','retail','plot','villa','independent_house','studio','other')),
    facing        varchar(40),
    furnishing    varchar(30) CHECK (furnishing IN ('unfurnished','semi_furnished','fully_furnished')),
    features      text[],
    plan_image_url text,
